        ...
        <>
            ...
            >
                ...
                <div className="h-full flex flex-col">
                    <div className="flex-1 p-2 sm:p-3 md:p-4 flex items-center justify-center bg-white/50">
                        <AnimatePresence mode="wait">
                            <motion.div
                                ...
                                onClick={onClose}
                            >
                                <MediaItem item={selectedItem} className="w-full h-full object-contain bg-white/20" onClick={onClose} />
                ...
                <motion.button
                    className="absolute top-2 sm:top-2.5 md:top-3 right-2 sm:right-2.5 md:right-3 
                              p-2 rounded-full bg-cosmic-700/20 text-cosmic-700 hover:bg-cosmic-700/30 
                              text-xs sm:text-sm backdrop-blur-sm border border-cosmic-700/30"
                    onClick={onClose}
            ...
            >
                <motion.div
                    className="relative rounded-xl bg-cosmic-700/10 backdrop-blur-xl 
                             border border-cosmic-700/30 shadow-lg
                    ...
                    <div className="flex items-center -space-x-2 px-3 py-2">
                        {mediaItems.map((item, index) => (
                            <motion.div
                                ...
                                className={`
                                    ...
                                    ${selectedItem.id === item.id
                                        ? 'ring-2 ring-cosmic-700/70 shadow-lg'
                                        : 'hover:ring-2 hover:ring-cosmic-700/30'}
                                `}
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-cosmic-700/5 to-cosmic-700/20" />
                                {selectedItem.id === item.id && (
                                    <motion.div
                                        layoutId="activeGlow"
                                        className="absolute -inset-2 bg-cosmic-700/20 blur-xl"
                                        initial={{ opacity: 0 }}
                                        animate={{ opacity: 1 }}
